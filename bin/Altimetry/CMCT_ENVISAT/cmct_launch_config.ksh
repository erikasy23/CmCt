...
#Added envisat for ERS Data
envisat_CMCTNC_GRN_CFG=${CMCTBIN}/envisat_cmctnc_grn_config.json
#Added envisat for ERS Data
envisat_CMCTNC_GRN_CFG=${CMCTBIN}/envisat_cmctnc_grn_config.json
CONFIGS="${DATASETS_CFG} ${ICESAT_CISM_CFG} ${ICESAT_CMCTNC_GRN_CFG} ${envisat_CMCTNC_GRN_CFG}"
#CONFIGS="${DATASETS_CFG} ${ICESAT_CISM_CFG} ${ICESAT_CMCTNC_GRN_CFG} ${envisat_CMCTNC_GRN_CFG} ${envisat_CMCTNC_GRN_CFG}"
