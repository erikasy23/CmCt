...
CONTAINS
  ...
  SUBROUTINE open( self, mission, dataset, envisat_campaign, status, verbosity )
    ...
    case ( 'envisat' ) SEL_MISSION
       ...
       !!
       !! DATASETS: envisat-CMCTNC-*-GRN
       !!
       case ("envisat-cmctnc-wgselev-grn", &
            "envisat-cmctnc-egmmtelev-grn", &
            "envisat-cmctnc-egmtfelev-grn" ) SEL_DS
  ...
  SUBROUTINE next_obs ( self, lat, lon, value, status, verbosity )
    ...
    !!
    !! DATASETS: envisat-CMCTNC-*-GRN
    !! From the envisat CMCT Greenland datasets in netCDF format
    !!
    case ("envisat-cmctnc-wgselev-grn", &
         "envisat-cmctnc-egmmtelev-grn", &
         "envisat-cmctnc-egmtfelev-grn" )
       ...
       case ( "envisat-cmctnc-egmmtelev-grn" )
          recQual = self%envisat_cmctnc%clean( rec=icmct_rec, &
       ...
       case ( "envisat-cmctnc-egmtfelev-grn" )
