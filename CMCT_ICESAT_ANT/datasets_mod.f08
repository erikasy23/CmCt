...
CONTAINS
  ...
  SUBROUTINE open( self, mission, dataset, icesat_campaign, status, verbosity )
    ...
    case ( 'icesat-glas' ) SEL_MISSION
       ...
       !!
       !! DATASETS: ICESAT-CMCTNC-*-GRN-*-ANT
       !!
       case ( "icesat-cmctnc-tpelev-ant", &
              "icesat-cmctnc-wgselev-ant", &
              "icesat-cmctnc-egmmtelev-ant", &
              "icesat-cmctnc-egmtfelev-ant") SEL_DS
  ...
  SUBROUTINE next_obs ( self, lat, lon, value, status, verbosity )
    ...
    !! From the ICESat-GLAS CMCT Antarctica datasets in netCDF format
    !!
    case ( "icesat-cmctnc-tpelev-ant", &
         "icesat-cmctnc-wgselev-ant", &
         "icesat-cmctnc-egmmtelev-ant", &
