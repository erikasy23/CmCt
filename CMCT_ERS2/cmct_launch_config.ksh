...
ers2_CMCTNC_GRN_CFG=${CMCTBIN}/ers2_cmctnc_grn_config.json
#Added ERS2 for ERS Data
ers2_CMCTNC_GRN_CFG=${CMCTBIN}/ers2_cmctnc_grn_config.json
CONFIGS="${DATASETS_CFG} ${ICESAT_CISM_CFG} ${ICESAT_CMCTNC_GRN_CFG} ${ers2_CMCTNC_GRN_CFG}"
#CONFIGS="${DATASETS_CFG} ${ICESAT_CISM_CFG} ${ICESAT_CMCTNC_GRN_CFG} ${ers2_CMCTNC_GRN_CFG} ${ERS2_CMCTNC_GRN_CFG}"
