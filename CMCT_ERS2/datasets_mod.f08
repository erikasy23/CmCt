...
CONTAINS
  ...
  SUBROUTINE open( self, mission, dataset, ers2_campaign, status, verbosity )
    ...
    case ( 'ers2' ) SEL_MISSION
       ...
       !!
       !! DATASETS: ers2-CMCTNC-*-GRN
       !!
       case ("ers2-cmctnc-wgselev-grn", &
            "ers2-cmctnc-egmmtelev-grn", &
            "ers2-cmctnc-egmtfelev-grn" ) SEL_DS
  ...
  SUBROUTINE next_obs ( self, lat, lon, value, status, verbosity )
    ...
    !!
    !! DATASETS: ers2-CMCTNC-*-GRN
    !! From the ers2 CMCT Greenland datasets in netCDF format
    !!
    case ("ers2-cmctnc-wgselev-grn", &
         "ers2-cmctnc-egmmtelev-grn", &
         "ers2-cmctnc-egmtfelev-grn" )
       ...
       case ( "ers2-cmctnc-egmmtelev-grn" )
          recQual = self%ers2_cmctnc%clean( rec=icmct_rec, &
       ...
       case ( "ers2-cmctnc-egmtfelev-grn" )
