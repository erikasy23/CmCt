...
CONTAINS
  ...
  SUBROUTINE open( self, mission, dataset, ers1_campaign, status, verbosity )
    ...
    case ( 'ers1' ) SEL_MISSION
       ...
       !!
       !! DATASETS: ERS1-CMCTNC-*-GRN
       !!
       case ("ers1-cmctnc-wgselev-grn", &
            "ers1-cmctnc-egmmtelev-grn", &
            "ers1-cmctnc-egmtfelev-grn" ) SEL_DS
  ...
  SUBROUTINE next_obs ( self, lat, lon, value, status, verbosity )
    ...
    !!
    !! DATASETS: ERS1-CMCTNC-*-GRN
    !! From the ERS1 CMCT Greenland datasets in netCDF format
    !!
    case ("ers1-cmctnc-wgselev-grn", &
         "ers1-cmctnc-egmmtelev-grn", &
         "ers1-cmctnc-egmtfelev-grn" )
       ...
       case ( "ers1-cmctnc-egmmtelev-grn" )
          recQual = self%ers1_cmctnc%clean( rec=icmct_rec, &
       ...
       case ( "ers1-cmctnc-egmtfelev-grn" )
