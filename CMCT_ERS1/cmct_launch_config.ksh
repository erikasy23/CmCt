...
#Added ERS1 for ERS Data
ERS1_CMCTNC_GRN_CFG=${CMCTBIN}/ers1_cmctnc_grn_config.json
#Added ERS2 for ERS Data
ERS1_CMCTNC_GRN_CFG=${CMCTBIN}/ers1_cmctnc_grn_config.json
CONFIGS="${DATASETS_CFG} ${ICESAT_CISM_CFG} ${ICESAT_CMCTNC_GRN_CFG} ${ERS1_CMCTNC_GRN_CFG}"
#CONFIGS="${DATASETS_CFG} ${ICESAT_CISM_CFG} ${ICESAT_CMCTNC_GRN_CFG} ${ERS1_CMCTNC_GRN_CFG} ${ERS2_CMCTNC_GRN_CFG}"
