...
#output_summary_csv = "/Users/erika/CmCt/glacier/hugonnet_scripts/oggm_change_summary.csv" #set
...
with open("comparison_csv/all_rgi_ids_by_region.json", "w") as f:
    json.dump(rgiids_export, f)
print("Exported RGI IDs by region to comparison_csv/all_rgi_ids_by_region.json")
