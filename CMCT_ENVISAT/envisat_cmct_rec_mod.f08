...
module envisat_cmct_rec_mod
  ...
  private
  public :: envisat_cmct_rec

  type envisat_cmct_rec
     sequence

     ! Shot time in seconds since J2000.0 from GLAS record
     real( kind=REAL64 )   :: MJDTime_j2000s
     ...
     real( kind=REAL32 )   :: elev_wgs84_m

     ! Elevation relative to EGM2008 mean-tide geoid
     real( kind=REAL32 )   :: elev_egm08meantide_m

     ! Elevation relative to EGM2008 tide-free geoid
     real( kind=REAL32 )   :: elev_egm08tidefree_m
  ...
  end type envisat_cmct_rec

end module envisat_cmct_rec_mod
